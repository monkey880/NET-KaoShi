		...
		<form id="Form1" method="post" runat="server">
			<table height="540" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<tr>
					<td valign="top">
						<!--内容开始-->
						<table  width="98%" align="center" class="pad5">
							<TBODY>
								<tr>
									...
									<td vAlign="top" align="center"><asp:datagrid id="DataGridNews" runat="server" Width="100%" AllowSorting="True" PageSize="15"
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="操作">
													...
													<ItemStyle HorizontalAlign="Center"></ItemStyle>
													<ItemTemplate>
														<asp:HyperLink id="LinkButEditNews" runat="server" CausesValidation="false" CommandName="Edit"
															Text="修改">修改</asp:HyperLink>&nbsp;
								...
								<tr>
									<td style="HEIGHT: 22px" align="center">
                                        ...
                                        <asp:HyperLink id="ButIssuNews" runat="server" CssClass="button" Text="发布新闻"></asp:HyperLink>&nbsp;
											<asp:button id="ButDelete" runat="server" CssClass="button" Text="删除新闻" onclick="ButDelete_Click"></asp:button></FONT></td>
								</tr>
				</tr>
			</table>
