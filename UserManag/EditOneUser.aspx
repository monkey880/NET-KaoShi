...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table height="392" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				<tr>
					<td height="0"></td>
				</tr>
				<tr>
							...
							<tr>
								<td >
									<TABLE id="Table2" style="BORDER-COLLAPSE: collapse" borderColor="#111111" cellSpacing="0"
                                        ...
                                        <TR>
											<td style="WIDTH: 178px" align="right" height="23">ID：</td>
											<td width="336" height="23" colspan="2"><asp:textbox id="txtUserID" runat="server" Enabled="false"  CssClass="text"></asp:textbox></td>
										</TR>
										<TR>
										...
										<TR>
											...
											<td style="HEIGHT: 23px" width="120" rowspan="4"><asp:image id="ImageUser" runat="server" Width="120px" Height="150px" ImageUrl="../Images/UserImage.gif"
										...
										<TR>
											...
											<td width="336" height="23"><asp:textbox id="txtBirthday" runat="server" CssClass="text" Font-Size="9pt" Width="123px" onclick="new Calendar().show(this);" ></asp:textbox></td>
										</TR>
										<tr>
										...
										<asp:dropdownlist id="DDLDept" runat="server" Width="88px" Visible="false"></asp:dropdownlist><asp:dropdownlist id="DDLJob" runat="server" Width="88px" Visible="false"></asp:dropdownlist></tr>
										...
										<TR>
											...
											<td width="336" height="17" colspan="2" style="HEIGHT: 23px"><asp:dropdownlist id="DDLUserType" runat="server" Width="80px">
                                                ...
                                                <asp:ListItem Value="2">老师账户</asp:ListItem>
												</asp:dropdownlist></td>
										</TR>
										<tr>
