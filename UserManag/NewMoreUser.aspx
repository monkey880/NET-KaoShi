								...
								<td>
									<TABLE id="Table2" style="BORDER-COLLAPSE: collapse" borderColor="#111111" height="200"
										...
										<TR>
											...
											<td width="324" height="23"><asp:textbox id="txtSLoginID" runat="server" CssClass="text"></asp:textbox></td>
										</TR>
										<TR>
											<td style="WIDTH: 176px" align="right" height="23">终止帐号：</td>
											<td width="324" height="23"><asp:textbox id="txtELoginID" runat="server" CssClass="text"></asp:textbox></td>
										</TR>
										<TR>
											<td style="WIDTH: 176px" align="right" height="23">所属部门：</td>
											<td width="324" height="23"><asp:dropdownlist id="DDLDept" runat="server" Width="88px"></asp:dropdownlist></td>
										</TR>
										<tr>
											<td style="WIDTH: 176px" align="right" height="23">职&nbsp;&nbsp; &nbsp;务：</td>
											<td width="324" height="23"><asp:dropdownlist id="DDLJob" runat="server" Width="88px"></asp:dropdownlist></td>
										</tr>
										<TR>
											<td style="WIDTH: 176px" align="right" height="23">类&nbsp;&nbsp; &nbsp;型：</td>
											<td width="324" height="23"><asp:dropdownlist id="DDLUserType" runat="server" Width="88px">
										...
										<TR>
											...
											<TD width="324" height="23"><FONT face="宋体"><asp:dropdownlist id="DDLUserState" runat="server" Width="88px">
