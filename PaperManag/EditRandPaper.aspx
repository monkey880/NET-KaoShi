						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="300" cellSpacing="0"
							...
							<tr>
								<td style="COLOR: #990000" align="center" background="../Images/bg_dh_middle.gif" bgColor="#ffffff"
									height="24">
									<font face="黑体" style="FONT-SIZE: 16px" color="#ffffff">修改随机作业</font></td>
							</tr>
							<tr>
								<td vAlign="top" align="center">
									<TABLE id="Table1" style="BORDER-COLLAPSE: collapse" borderColor="#dadada" cellSpacing="0"
										...
										<TR>
										  <td style="WIDTH: 67px" align="right">作业简介：</td>
										  <td colSpan="3"><asp:textbox id="txtPaperContent" runat="server" CssClass="text" Width="600px" Height="150px" MaxLength="80" TextMode="MultiLine"></asp:textbox></td>
									  </TR>
										<TR bgColor="#ebf5fa" height="16">
