							...
							<tr>
								<td vAlign="top" align="center">
									<TABLE id="Table1" style="BORDER-COLLAPSE: collapse" borderColor="#dadada" cellSpacing="0"
										...
										<TR>
											<td width="265" style="WIDTH: 67px">作业名称：</td>
										...
										<TR bgColor="#ebf5fa" height="16">
											<TD width="991" height="20" colSpan="2" align="center"><STRONG>试题策略</STRONG></TD>
										</TR>
										<TR>
											<TD align="center" colSpan="2"><asp:button id="ButAddPolicy" runat="server" CssClass="text" Text="知识点" onclick="ButAddPolicy_Click"></asp:button></TD>
										</TR>
										<TR>
