...
namespace EasyExam.Teacher
{
	...
	/// ManagUserList 的摘要说明。
	/// </summary>
	public partial class UserLoreList : System.Web.UI.Page
	{
		...
		{			
			...
			if (!IsPostBack)
			{
				...
				else
				{
                    ...
                    strSql = "select a.LoreID,a.LoreName,(b.Score*100/9) as Score from LoreInfo a left outer join LoreScore b on a.LoreID=b.LoreID  where b.UserID =" + intUserID + "  order by b.Score desc";
		...
		private void ShowData(string strSql)
		{
			...
			{
                Label lblLoreScore = (Label)DataGridUser.Items[i].FindControl("lblLoreScore");
                lblLoreScore.Text = Math.Round(Convert.ToDouble(DataGridUser.Items[i].Cells[1].Text)) + "%";
