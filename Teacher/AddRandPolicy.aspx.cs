...
namespace EasyExam.PaperManag
{
	...
	public partial class AddRandPolicy : System.Web.UI.Page
	{
		...
		private void ShowData(string strSql)
		{
			...
			{				
                //SqlCmdTmp=new SqlDataAdapter("select * from RubricInfo where SubjectID="+SqlDS.Tables[0].Rows[i]["SubjectID"]+"and LoreID="+SqlDS.Tables[0].Rows[i]["LoreID"]+" and TestTypeID="+SqlDS.Tables[0].Rows[i]["TestTypeID"]+" and TestDiff='易'",SqlConn);
                ...
                //SqlCmdTmp=new SqlDataAdapter("select * from RubricInfo where SubjectID="+SqlDS.Tables[0].Rows[i]["SubjectID"]+"and LoreID="+SqlDS.Tables[0].Rows[i]["LoreID"]+" and TestTypeID="+SqlDS.Tables[0].Rows[i]["TestTypeID"]+" and TestDiff='较易'",SqlConn);
                //SqlDSTmp=new DataSet();
                //SqlCmdTmp.Fill(SqlDSTmp,"RubricInfo");
                ...
                //SqlCmdTmp=new SqlDataAdapter("select * from RubricInfo where SubjectID="+SqlDS.Tables[0].Rows[i]["SubjectID"]+"and LoreID="+SqlDS.Tables[0].Rows[i]["LoreID"]+" and TestTypeID="+SqlDS.Tables[0].Rows[i]["TestTypeID"]+" and TestDiff='中等'",SqlConn);
                //SqlDSTmp=new DataSet();
                //SqlCmdTmp.Fill(SqlDSTmp,"RubricInfo");
                ...
                //SqlCmdTmp=new SqlDataAdapter("select * from RubricInfo where SubjectID="+SqlDS.Tables[0].Rows[i]["SubjectID"]+"and LoreID="+SqlDS.Tables[0].Rows[i]["LoreID"]+" and TestTypeID="+SqlDS.Tables[0].Rows[i]["TestTypeID"]+" and TestDiff='较难'",SqlConn);
                //SqlDSTmp=new DataSet();
                //SqlCmdTmp.Fill(SqlDSTmp,"RubricInfo");
                ...
                //SqlCmdTmp=new SqlDataAdapter("select * from RubricInfo where SubjectID="+SqlDS.Tables[0].Rows[i]["SubjectID"]+"and LoreID="+SqlDS.Tables[0].Rows[i]["LoreID"]+" and TestTypeID="+SqlDS.Tables[0].Rows[i]["TestTypeID"]+" and TestDiff='难'",SqlConn);
                //SqlDSTmp=new DataSet();
                //SqlCmdTmp.Fill(SqlDSTmp,"RubricInfo");
...
//			}
            ...
            if (AccessDateHelper.GetValues("select PaperPolicyID from PaperPolicy where SubjectID=" + DDLSubjectName.SelectedItem.Value + " and LoreID=" + DDLLoreName.SelectedItem.Value + " and TestTypeID=" + DDLTestTypeName.SelectedItem.Value + " and PaperID=" + intPaperID + "", "PaperPolicyID") == "")
			{
                ...
                //AccessDateHelper.ExecuteNonQuery();
			...
			for(int i=0;i<SqlDS.Tables[0].Rows.Count;i++)
			{
				...
				if (intSum>0)
				{
                    //ObjectCmd.CommandText="INSERT INTO PaperTest(PaperID,RubricID,TestMark) SELECT top "+intSum.ToString()+" "+intPaperID.ToString()+" AS PaperID,RubricID,TestMark FROM RubricInfo where SubjectID="+SqlDS.Tables[0].Rows[i]["SubjectID"]+" and LoreID="+SqlDS.Tables[0].Rows[i]["LoreID"]+" and TestTypeID="+SqlDS.Tables[0].Rows[i]["TestTypeID"]+" and TestDiff='较易' ORDER BY NEWID()";
                    //ObjectCmd.ExecuteNonQuery();
				...
				if (intSum>0)
				{
                    //ObjectCmd.CommandText="INSERT INTO PaperTest(PaperID,RubricID,TestMark) SELECT top "+intSum.ToString()+" "+intPaperID.ToString()+" AS PaperID,RubricID,TestMark FROM RubricInfo where SubjectID="+SqlDS.Tables[0].Rows[i]["SubjectID"]+" and LoreID="+SqlDS.Tables[0].Rows[i]["LoreID"]+" and TestTypeID="+SqlDS.Tables[0].Rows[i]["TestTypeID"]+" and TestDiff='中等' ORDER BY NEWID()";
                    //ObjectCmd.ExecuteNonQuery();
				...
				if (intSum>0)
				{
                    //ObjectCmd.CommandText="INSERT INTO PaperTest(PaperID,RubricID,TestMark) SELECT top "+intSum.ToString()+" "+intPaperID.ToString()+" AS PaperID,RubricID,TestMark FROM RubricInfo where SubjectID="+SqlDS.Tables[0].Rows[i]["SubjectID"]+" and LoreID="+SqlDS.Tables[0].Rows[i]["LoreID"]+" and TestTypeID="+SqlDS.Tables[0].Rows[i]["TestTypeID"]+" and TestDiff='较难' ORDER BY NEWID()";
                    //ObjectCmd.ExecuteNonQuery();
				...
				if (intSum>0)
				{
                    //ObjectCmd.CommandText="INSERT INTO PaperTest(PaperID,RubricID,TestMark) SELECT top "+intSum.ToString()+" "+intPaperID.ToString()+" AS PaperID,RubricID,TestMark FROM RubricInfo where SubjectID="+SqlDS.Tables[0].Rows[i]["SubjectID"]+" and LoreID="+SqlDS.Tables[0].Rows[i]["LoreID"]+" and TestTypeID="+SqlDS.Tables[0].Rows[i]["TestTypeID"]+" and TestDiff='难' ORDER BY NEWID()";
                    //ObjectCmd.ExecuteNonQuery();
                    AccessDateHelper.ExecuteNonQuery("INSERT INTO PaperTest(PaperID,RubricID,TestMark) SELECT top " + intSum.ToString() + " " + intPaperID.ToString() + " AS PaperID,RubricID,TestMark FROM RubricInfo where SubjectID=" + SqlDS.Tables[0].Rows[i]["SubjectID"] + " and LoreID=" + SqlDS.Tables[0].Rows[i]["LoreID"] + " and TestTypeID=" + SqlDS.Tables[0].Rows[i]["TestTypeID"] + " and TestDiff='难' ORDER BY NEWID()");
				}
			}
