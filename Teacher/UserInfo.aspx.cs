...
namespace EasyExam.PersonInfo
{
	...
	public partial class UserInfo : System.Web.UI.Page
	{
		...
		private void LoadUserData()
		{
            ...
            OleDbDataReader ObjDR = AccessDateHelper.ExecuteReader("select a.UserID,a.LoginID,a.UserName,a.UserSex,a.Birthday,b.DeptName,a.Telephone,a.CertType,a.CertNum,a.LoginIP,c.JobName,iif( a.UserType = 1,'管理帐户',iif(a.UserType= 0,'普通帐户' ,'')) as UserType, iif( a.UserState = 1, '正常',iif(a.UserState= 0,'禁止')) as UserState  from JobInfo as c RIGHT JOIN (DeptInfo as b RIGHT JOIN UserInfo as a ON b.DeptID = a.DeptID) ON c.JobID = a.JobID where a.LoginID='" + myLoginID + "'");
