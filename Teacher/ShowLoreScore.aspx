<%@ Page language="c#" Inherits="EasyExam.Teacher.ShowLoreScore" CodeFile="LoreUserList.aspx.cs" %>
								...
								<td vAlign="top" align="center"><asp:datagrid id="DataGridUser" runat="server" Width="100%" PageSize="15" CellPadding="0" BorderWidth="1px"
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderText="操作">
												...
												<ItemStyle HorizontalAlign="Center"></ItemStyle>
												<ItemTemplate>
													<asp:HyperLink  id="LinkButUserScore" runat="server">查看学生掌握程度</asp:HyperLink>&nbsp;
