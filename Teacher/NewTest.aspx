<%@ Page language="c#" Inherits="EasyExam.Teacher.NewTest" CodeFile="NewTest.aspx.cs" %>
		...
		<script language="javascript">
		    function TestTypeNameChange() {
		        ...
		        if (strTestTypeName.indexOf("单选类") > 0) {
		            document.all("OptionContent").style.display = "";
		            document.all("LabStandardAnswer").innerHTML = "试题选项：";
		            document.all("PlSelect").style.display = "";
		            for (i = 1; i <= 6; i++) {
		                document.all("PlOneSelect" + i).style.display = "";
		        ...
		        if (strTestTypeName.indexOf("多选类") > 0) {
		            ...
		            for (i = 1; i <= 6; i++) {
		                ...
		                document.all("PlMultiSelect" + i).style.display = "";
		            }
		            document.all("txtTestMark").value = "2";
		        }
		    ...
		    function OptionNumChange() {
		        ...
		        for (i = 1; i <= num; i++) {
		            document.all("trOneSelect" + i).style.display = "";
		        }
		    }
		    function OpenHtmlEditor(index) {
		        ...
		        if (top < 0) { top = 0; }
		        win = window.open("../RubricManag/HtmlEditor.aspx", "HtmlEditor", "toolbar=no, menubar=no, scrollbars=no,resizable=no,location=no,status=yes,width=" + width + ",height=" + height + ",left=" + left + ",top=" + top);
		    }
    ...
    <div class="cols two-cols user">
      ...
      <h3>试题管理</h3>
		...
		<form id="Form1" method="post" runat="server">
				  ...
				  <td>
						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="200" cellSpacing="0"
							...
							<TR>
								...
								<td height="19" width="148"><asp:dropdownlist id="DDLTestDiff" runat="server" Width="110px" Visible="false">
								...
								<td style="WIDTH: 75px; HEIGHT: 23px" align="right" height="19"></td>
								<td height="19" width="148"><FONT face="宋体"><asp:textbox id="txtTestMark" runat="server" Width="110px" Visible="false"></asp:textbox></FONT></td>
							</TR>
							<TR>
							...
							<TR id="OptionContent">
								...
								<td width="586" colSpan="6" style="WORD-BREAK: break-all">
							...
							<TR>
								...
								<td style="HEIGHT: 23px" width="586" colSpan="5" >
			...
			<!--内容结束--> </TD></TR></TABLE><asp:TextBox ID="txtTestContent8" runat="server" Width="100%" Height="55px" TextMode="MultiLine"
