...
namespace EasyExam.Teacher
{
    ...
    /// ManagTestList 的摘要说明。
    /// </summary>
    public partial class RubricManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    strSql = "select a.RubricID,b.SubjectName,c.LoreName,d.TestTypeName,a.TestContent,e.LoginID as CreateLoginID,a.CreateDate as CreateDate from (((RubricInfo a LEFT  JOIN SubjectInfo b ON a.SubjectID=b.SubjectID) LEFT  JOIN LoreInfo c ON a.LoreID=c.LoreID )LEFT  JOIN TestTypeInfo d ON a.TestTypeID=d.TestTypeID )LEFT  JOIN UserInfo e ON a.CreateUserID=e.UserID where a.CreateUserID="+Convert.ToInt32(myUserID)+" order by a.RubricID desc";
        ...
        {
            bWhere = false;
            strSql = "select a.RubricID,b.SubjectName,c.LoreName,d.TestTypeName,a.TestContent,e.LoginID as CreateLoginID,a.CreateDate as CreateDate from (((RubricInfo a LEFT  JOIN SubjectInfo b ON a.SubjectID=b.SubjectID) LEFT  JOIN LoreInfo c ON a.LoreID=c.LoreID) LEFT  JOIN TestTypeInfo d ON a.TestTypeID=d.TestTypeID) LEFT  JOIN UserInfo e ON a.CreateUserID=e.UserID where a.CreateUserID=" + Convert.ToInt32(myUserID) + "";
            bWhere = true;
            //显示以科目为条件的数据
