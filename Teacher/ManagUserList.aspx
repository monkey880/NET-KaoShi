<%@ Page language="c#" Inherits="EasyExam.Teacher.ManagUserList" CodeFile="ManagUserList.aspx.cs" %>
						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="500" cellSpacing="0"
							...
							<tr>
								<td style="HEIGHT: 22px">
									<asp:dropdownlist id="DDLDept" runat="server" Width="78px" Visible="false"></asp:dropdownlist>帐号：
								...
								<td vAlign="top" align="center"><asp:datagrid id="DataGridUser" runat="server" Width="100%" PageSize="15" CellPadding="0" BorderWidth="1px"
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderText="操作">
												...
												<ItemStyle HorizontalAlign="Center"></ItemStyle>
												<ItemTemplate>
													<asp:HyperLink  id="LinkButTestLog" runat="server">答题记录</asp:HyperLink>&nbsp;
                                                    <asp:HyperLink id="LinkButLore" runat="server">掌握知识点</asp:HyperLink>&nbsp;
