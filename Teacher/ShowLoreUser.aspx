<%@ Page language="c#" Inherits="EasyExam.Teacher.ShowLoreUser" CodeFile="ShowLoreUser.aspx.cs" %>
						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="500" cellSpacing="0"
							...
							<tr>
								<td style="COLOR: #990000" align="center" background="../Images/bg_dh_middle.gif" bgColor="#ffffff"
									height="24"><font style="FONT-SIZE: 16px" face="黑体" color="#ffffff">学生知识点掌握程度</font></td>
							</tr>
							<tr>
							...
							<tr>
								<td vAlign="top" align="center"><asp:datagrid id="DataGridUser" runat="server" Width="100%" PageSize="15" CellPadding="0" BorderWidth="1px"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="UserName" SortExpression="UserName" HeaderText="用户"></asp:BoundColumn>
