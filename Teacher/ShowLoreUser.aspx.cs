...
namespace EasyExam.Teacher
{
	...
	/// ManagUserList 的摘要说明。
	/// </summary>
	public partial class ShowLoreUser : System.Web.UI.Page
	{
		...
		{			
			...
			if (!IsPostBack)
			{
				...
				else
				{
                    ...
                    strSql = "select a.Score ,b.UserName,b.UserID from LoreScore a left join UserInfo b on a.UserID = b.UserID where a.LoreID= "+intLoreID;
		...
		private void ShowData(string strSql)
		{
			...
			{
                Label lblUserScore = (Label)DataGridUser.Items[i].FindControl("lblUserScore");
                lblUserScore.Text=(Convert.ToInt16(DataGridUser.Items[i].Cells[1].Text)*100/9).ToString()+"%";
