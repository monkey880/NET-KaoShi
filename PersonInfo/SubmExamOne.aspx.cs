		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ((intPaperID!=0)&&(intUserScoreID!=0))
			{
                ...
                //{
                    ...
                    SqlDSTest = AccessDateHelper.ExecuteDataset("select a.RubricID,a.TestMark,b.StandardAnswer,a.UserAnswer,d.BaseTestType,a.TestOrder from UserAnswer a,RubricInfo b,PaperTestType c,TestTypeInfo d where a.RubricID=b.RubricID and b.TestTypeID=c.TestTypeID and b.TestTypeID=d.TestTypeID and a.UserScoreID=" + intUserScoreID + " and c.PaperID=" + intPaperID + " order by c.PaperTestTypeID,a.TestOrder");
