...
namespace EasyExam.PersonInfo
{
	...
	public partial class BrowNews : System.Web.UI.Page
	{
		...
		private void LoadNewsData()
		{
           ...
           int query= AccessDateHelper.ExecuteNonQuery("update NewsInfo set BrowNumber=BrowNumber+1 where NewsID="+intNewsID+"");
           ...
           OleDbDataReader ObjDR = AccessDateHelper.ExecuteReader("select a.NewsTitle,a.NewsContent,a.BrowNumber,a.CreateDate,b.LoginID as CreateLoginID from NewsInfo a LEFT OUTER JOIN UserInfo b ON a.CreateUserID=b.UserID where NewsID=" + intNewsID);
