	...
	public partial class ShowStatis : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (intUserScoreID!=0)
			{
                ...
                SqlDS = AccessDateHelper.ExecuteDataset("select * from UserScore where UserScoreID=" + intUserScoreID + " order by UserScoreID asc");

				intPaperID=Convert.ToInt32(SqlDS.Tables[0].Rows[0]["PaperID"]);
				intUserID=Convert.ToInt32(SqlDS.Tables[0].Rows[0]["UserID"]);
                ...
                SqlDS = AccessDateHelper.ExecuteDataset("select * from UserInfo where UserID=" + intUserID + " order by UserID asc");
		...
		private void ShowData(string strSql)
		{
            ...
            SqlDS = AccessDateHelper.ExecuteDataset(strSql);
			...
			DataGridStatis.DataSource=SqlDS.Tables[0].DefaultView;
