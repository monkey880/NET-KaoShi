	...
	public partial class ShowOrder : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				if (intPaperID!=0)
				{
                    intOrder = Convert.ToInt32(AccessDateHelper.GetValues("select count(*) as count from UserScore where PaperID=" + intPaperID + " and ExamState=1 and TotalMark>" + dblCurTotalMark + "", "count")) + 1;
