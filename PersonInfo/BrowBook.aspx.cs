...
namespace EasyExam.PersonInfo
{
	...
	public partial class BrowBook : System.Web.UI.Page
	{
		...
		private void LoadSectionData()
		{
            ...
            AccessDateHelper.ExecuteNonQuery("update SectionInfo set BrowNumber=BrowNumber+1 where SectionID=" + intSectionID + "");
            ...
            OleDbDataReader ObjDR = AccessDateHelper.ExecuteReader("select a.SectionName,a.SectionContent,a.BrowNumber,a.CreateDate,c.LoginID as CreateLoginID from (SectionInfo a LEFT JOIN ChapterInfo b ON a.ChapterID = b.ChapterID) LEFT JOIN UserInfo c ON b.CreateUserID = c.UserID where SectionID=" + intSectionID + "");
