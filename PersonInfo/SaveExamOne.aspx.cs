		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ((intPaperID!=0)&&(intUserScoreID!=0))
			{
				try
				{
					...
					//ObjCmd.ExecuteNonQuery();
                    AccessDateHelper.ExecuteNonQuery("Update UserScore set EndTime=date(),RemTime=" + intRemTime + ",LoginIP='" + Convert.ToString(Request.ServerVariables["Remote_Addr"]) + "' where UserScoreID=" + intUserScoreID);
