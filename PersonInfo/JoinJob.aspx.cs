	...
	public partial class JoinJob : System.Web.UI.Page
	{
		...
		private void ShowData(string strSql)
		{
			...
			{				
                ...
                HyperLink LBStartExam2 = (HyperLink)DataGridPaper.Items[i].FindControl("LinkButStartExam2");
                HyperLink LBStartExam3 = (HyperLink)DataGridPaper.Items[i].FindControl("LinkButStartExam3");
				
                    LBStartExam2.NavigateUrl = "Practise.aspx?PaperID=" + DataGridPaper.Items[i].Cells[0].Text.Trim() + "&UserID=" + intUserID + "&Start=yes";
                    LBStartExam2.Target = "_blank";
                    LBStartExam3.NavigateUrl = "StartJobAll.aspx?PaperID=" + DataGridPaper.Items[i].Cells[0].Text.Trim() + "&UserID=" + intUserID + "&Start=yes";
                    LBStartExam3.Target = "_blank";
