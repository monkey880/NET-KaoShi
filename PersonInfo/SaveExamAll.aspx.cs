		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ((intPaperID!=0)&&(intUserScoreID!=0))
			{
				try
				{
                    ...
                    string sqldaan = "Update UserAnswer set UserScoreID=" + intUserScoreID + " ,RubricID = " + BuilderRubricID + " ,UserAnswer=" + BuilderUserAnswer.ToString() + " UserScore=" + BuilderUserScore.ToString();
                    AccessDateHelper.ExecuteNonQuery(sqldaan); 
                    ...
                    AccessDateHelper.ExecuteNonQuery("Update UserScore set EndTime=Getdate(),RemTime=" + intRemTime + ",LoginIP='" + Convert.ToString(Request.ServerVariables["Remote_Addr"]) + "' where UserScoreID=" + intUserScoreID + "");
				}
				catch
				{
