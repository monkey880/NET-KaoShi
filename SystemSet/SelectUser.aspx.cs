...
namespace EasyExam.SystemSet
{
	...
	public partial class SelectUser : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
                if (Convert.ToInt32(AccessDateHelper.GetValues("select JudgeUser from UserInfo where UserID=" + intUserID + "", "JudgeUser")) == 1)
				{
...
//				}
		...
		private void ShowSelectedData()
		{
            ...
            //objDS=new DataSet();
            //objCmd.Fill(objDS,"DeptInfo");
            DataSet objDS = AccessDateHelper.ExecuteDataset("select b.DeptID,b.DeptName from UserPower a,DeptInfo b where a.DeptID=b.DeptID and a.UserID=" + intUserID + " and a.PowerID=1 order by b.DeptName asc");
			for(int i=0;i<objDS.Tables[0].Rows.Count;i++)
			{
            ...
            //objDS=new DataSet();
            //objCmd.Fill(objDS,"UserInfo");
            DataSet objDS2 = AccessDateHelper.ExecuteDataset("select b.UserID,b.LoginID from UserPower a,UserInfo b where a.OptionID=b.UserID and a.UserID=" + intUserID + " and a.PowerID=1 order by a.OptionID asc");
			for(int i=0;i<objDS2.Tables[0].Rows.Count;i++)
			{
