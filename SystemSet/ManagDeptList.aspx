						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="500" cellSpacing="0"
							...
							<tr>
								<td style="COLOR: #990000" align="center" background="../Images/bg_dh_middle.gif" bgColor="#ffffff"
									height="24"><font style="FONT-SIZE: 16px" face="黑体" color="#ffffff">设置</font></td>
							</tr>
							<tr>
								<td height="23">&nbsp;群组名称：<asp:textbox id="txtDeptName" runat="server" Width="136px" CssClass="text"></asp:textbox>
							...
							<TR>
								<td vAlign="top" align="center"><asp:datagrid id="DataGridDept" runat="server" Width="100%" PageSize="15" CellPadding="0" BorderWidth="1px"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="DeptName" SortExpression="DeptName" HeaderText="群组名称"></asp:BoundColumn>
							...
							<tr>
								<td style="HEIGHT: 23px" align="center"><FONT face="宋体"><asp:button id="ButNewMoreDept" runat="server" CssClass="button" Text="批量添加"></asp:button>&nbsp;
										<asp:button id="ButDelete" runat="server" CssClass="button" Text="删除群组" onclick="ButDelete_Click"></asp:button></FONT></td>
							</tr>
						</table>
						<!--内容结束--></td>
				</tr>
