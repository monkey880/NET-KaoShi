						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="500" cellSpacing="0"
							...
							<tr>
								<td style="COLOR: #990000" align="center" background="../Images/bg_dh_middle.gif" bgColor="#ffffff"
									height="24"><font style="FONT-SIZE: 16px" face="黑体" color="#ffffff">会员类型设置</font></td>
							</tr>
							<tr>
								<td height="23">&nbsp;会员类型名称：<asp:textbox id="txtJobName" runat="server" CssClass="text" Width="136px"></asp:textbox>
