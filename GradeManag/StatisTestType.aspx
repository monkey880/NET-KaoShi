	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="1" width="95%" align="center" border="0">
				...
				<tr>
					<td align="center"><FONT face="����"><asp:datagrid id="DataGridTestType" runat="server" Width="100%" AutoGenerateColumns="False" BorderWidth="1px"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="TestTypeTitle" SortExpression="TestTypeTitle" HeaderText="���ͱ���"></asp:BoundColumn>
