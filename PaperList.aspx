<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaperList.aspx.cs" Inherits="EasyExam.PaperList" %>
...
<asp:datagrid id="DataGridNews" runat="server" Width="100%" AllowSorting="True" PageSize="15"
											...
											<Columns>
												...
												<asp:TemplateColumn SortExpression="NewsTitle" HeaderText="作业名称">
													<ItemTemplate>
													   <a href="PaperInfo.aspx?id=<%# Eval("PaperID") %>"><%# Eval("PaperName") %></a>
													</ItemTemplate>
												</asp:TemplateColumn>
