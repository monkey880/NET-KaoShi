...
namespace EasyExam.ProcessManag
{
	...
	public partial class ManagProcess : System.Web.UI.Page
	{
		...
		private void DataGridPaper_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
            ...
            AccessDateHelper.ExecuteNonQuery("delete UserAnswer from UserAnswer a LEFT OUTER JOIN UserScore b ON a.UserScoreID=b.UserScoreID where b.PaperID=" + intPaperID + "");
            AccessDateHelper.ExecuteNonQuery("delete from UserScore where PaperID=" + intPaperID + "");
			//自动翻页
