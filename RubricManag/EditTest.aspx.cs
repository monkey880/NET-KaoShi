...
namespace EasyExam.RubricManag
{
	...
	public partial class EditTest : System.Web.UI.Page
	{
		...
		private void LoadTestData()
		{
            ...
            OleDbDataReader ObjDR = AccessDateHelper.ExecuteReader("select a.RubricID,a.SubjectID,a.LoreID,a.TestTypeID,b.BaseTestType,a.TestDiff,a.OptionNum,a.TestMark,a.TestContent,a.TestFile,a.TestFileName,a.OptionContent,a.StandardAnswer,a.TestParse,a.CreateDate,a.CreateUserID from RubricInfo a,TestTypeInfo b where a.TestTypeID=b.TestTypeID and RubricID=" + intRubricID + "");
		...
		protected void ButInput_Click(object sender, System.EventArgs e)
		{
            ...
            string strTmp = AccessDateHelper.GetValues("select RubricID from RubricInfo where SubjectID=" + DDLSubjectName.SelectedItem.Value + " and LoreID=" + DDLLoreName.SelectedItem.Value + " and TestContent='" + strTestContent + " and RubricID<>" + intRubricID + "'", "RubricID");
			if (strTmp.Trim()!="")
			{
		...
		public int MyDatabaseMethod(int intSubjectID,int intLoreID,int intTestTypeID,string strTestDiff,int intOptionNum,double dblTestMark,string strTestContent,byte[] fileBinaryData,string strTestFileName,string strOptionContent,string strStandardAnswer,string strTestParse,int intCreateUserID,DateTime dtmCreateDate)
		{
			...
			OleDbParameter ParamTestDiff=new OleDbParameter("@TmpTestDiff",OleDbType.Char,6);
			...
			OleDbParameter ParamTestContent=new OleDbParameter("@TmpTestContent",OleDbType.LongVarChar,4000);
			ParamTestContent.Value = strTestContent;
			ObjCmd.Parameters.Add(ParamTestContent);

            //if (fileBinaryData.Length>0)
            //{
            //    //OleDbParameter ParamTestFile=new OleDbParameter("@TmpTestFile",OleDbType.Binary);
		...
		protected void lbtDeleFile_Click(object sender, System.EventArgs e)
		{
			try
			{
                AccessDateHelper.ExecuteNonQuery("Update RubricInfo set TestFileName='',TestFile=null where RubricID=" + intRubricID + "");
				lbtTestFile.Visible=false;
				lbtDeleFile.Visible=false;
				lbtTestFile.Text="";
		...
		protected void lbtTestFile_Click(object sender, System.EventArgs e)
		{
            ...
            OleDbDataReader ObjDR = AccessDateHelper.ExecuteReader("select * from RubricInfo where RubricID="+intRubricID+"");
			if (ObjDR.Read())
			{
