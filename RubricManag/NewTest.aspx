...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript" src="../JavaScript/ueditor_min/ueditor.all.js"></script>
<script type="text/javascript" src="../JavaScript/ueditor_min/ueditor.config.js"></script>
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		...
		var editor0 = UE.getEditor('txtTestContent0');
		var editor1 = UE.getEditor('txtTestContent1');
		var editor2 = UE.getEditor('txtTestContent2');
		var editor3 = UE.getEditor('txtTestContent3');
		var editor4 = UE.getEditor('txtTestContent4');
		var editor5 = UE.getEditor('txtTestContent5');
		var editor6 = UE.getEditor('txtTestContent6');
		var editor7 = UE.getEditor('txtTestContent7');
             </script>
		<script language="javascript">
			TestTypeNameChange();
			OptionNumChange();
