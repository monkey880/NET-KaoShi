...
<script type="text/javascript" src="../JavaScript/ueditor_min/ueditor.config.js"></script>
		...
		<script language="javascript">
				...
				{
				    var i;
					var strTestTypeName=$("#DDLTestTypeName").val();
					$("#OptionContent").hide();
					$("#PlSelect").hide();
					$("#PlJudge").hide();
					$("#PlOther").hide();
					...
					{
						$("#OptionContent").show();
						$("#LabStandardAnswer").html("试题选项：");
						$("#PlSelect").show();
						for(i=1;i<=6;i++)
						{
							$("#PlOneSelect"+i).show();
							$("#PlMultiSelect"+i).hide();
						}
						$("#txtTestMark").val("2");
					}
					...
					{
						$("#OptionContent").show();
						$("#LabStandardAnswer").innerHTML="标准答案：";
						$("#PlOther").show();
						$("#txtTestMark").val("10");
					}
					...
					{
						$("#OptionContent").show();
						$("#LabStandardAnswer").innerHTML="试题参数：";
						$("#PlType").show();
						$("#txtTestMark").val("10");
					}
					...
					{
						$("#OptionContent").show();
						$("#LabStandardAnswer").innerHTML="下载文件：";
						$("#PlOperate").show();
						$("#txtTestMark").val("10");
					}
				}
				...
				{
					return $("#txtTestContent"+$("#txtEditorIndex").value).value;
				}
				function HtmlEditorCallBack(text){
					$("#txtTestContent"+document.all("txtEditorIndex").value).value=text;
				}
		</script>
