...
namespace EasyExam.RubricManag
{
	...
	public partial class EditBook : System.Web.UI.Page
	{
		...
		protected void ButInput_Click(object sender, System.EventArgs e)
		{
			...
			SqlConn.Open();
			SqlCommand SqlCmd=new SqlCommand("update SectionInfo set SectionContent='"+ObjFun.getStr(ObjFun.CheckTestStr(Request["sectioncontent"].ToString()),4000)+"' where SectionID="+strSectionID+"",SqlConn);
