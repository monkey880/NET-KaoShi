...
namespace EasyExam.RubricManag
{
	...
	public partial class CountTest : System.Web.UI.Page
	{
		...
		private void ShowData(string strSql)
		{
			...
			DataGridCount.DataSource=SqlDS.Tables[0].DefaultView;
			...
			for(int i=0;i<DataGridCount.Items.Count;i++)
			{
                ...
                LBCountTestDist.Attributes.Add("onclick", "window.location.href='CountTestDist.aspx?SubjectID=" + DataGridCount.Items[i].Cells[0].Text.Trim() + "&SubjectName=" + DataGridCount.Items[i].Cells[2].Text.Trim() + "'; return false;");
			}
